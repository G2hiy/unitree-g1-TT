...
class MotionCommand(CommandTerm):
    ...
    def body_pos_w(self) -> torch.Tensor:
        ...
        return self.motion.body_pos_w[self.time_steps] + self._env.scene.env_origins[:, None, :] + offset
    ...
    def anchor_pos_w(self) -> torch.Tensor:
        offset = torch.tensor(self.cfg.motion_origin_offset, device=self.device)
        return self.motion.body_pos_w[self.time_steps, self.motion_anchor_body_index] + self._env.scene.env_origins + offset
...
class MotionCommandCfg(CommandTermCfg):
    ...
    motion_origin_offset: tuple[float, float, float] = (-1.8, 0.0, 0.0)
